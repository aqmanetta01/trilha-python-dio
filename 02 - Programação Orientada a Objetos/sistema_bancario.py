...
def recuperar_conta_cliente(cliente):
    ...
    if numero_conta.isdigit():
        ...
        print("=== Por favor, insira um número de conta válido. Veja a seguir suas contas válidas e tente novamente. ===")
...
def listar_contas(cliente, contas):
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            cpf_cliente = input("Informe o CPF do cliente para listar suas contas: ")
